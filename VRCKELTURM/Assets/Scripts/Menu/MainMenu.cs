...
public class MainMenu : MonoBehaviour
{
    public void LoadLevelOne() // Level 1 nur Holz
    {
        ...
        TowerBuilder.setTowerSettings(0, 18, 4, probability, 0.94f, 1.54f);
    ...
    public void LoadLevelTwo() // Level 2 viel holz und etwas von allem anderen
    {
        ...
        TowerBuilder.setTowerSettings(0, 18, 4, probability, 0.98f, 1.54f);
        SceneManager.LoadScene(SceneManager.GetActiveScene().buildIndex + 1);
    }
    ...
    public void LoadLevelThree() // Level 3 nur zum Zerstören
    {
         ...
         TowerBuilder.setTowerSettings(0, 32, 4, probability, 0.98f, 100f);
         SceneManager.LoadScene(SceneManager.GetActiveScene().buildIndex + 1);
    }
    ...
    public void LoadLevelFour() // Level 4 sehr rutschig
    {
      ...
      TowerBuilder.setTowerSettings(0, 20, 4, probability, 0.98f, 1.66f);
      SceneManager.LoadScene(SceneManager.GetActiveScene().buildIndex + 1);
    }
    ...
    {
        List<int> probability = new List<int>() {100,0,0,0,0};
        TowerBuilder.setTowerSettings(0, 0, 4, probability, 0.98f, 100f);
